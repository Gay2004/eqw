...
void load_images() {
    ...
    slow_image = LoadTexture("data/images/enemy.png");
}
...
void load_sounds() {
    ...
    exit_sound = LoadSound("data/sounds/exit.mp3");
    slow_sound = LoadSound("data/sounds/chin.mp3");
    spike_sound = LoadSound("data/sounds/spike.wav");
...
void unload_sounds() {
    ...
    UnloadSound(slow_sound);
    UnloadSound(spike_sound);
}
...
void load_music() {
    main_menu_music = LoadMusicStream("data/music/batman.mp3");
